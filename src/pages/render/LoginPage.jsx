            ...
            <div className="flex flex-col lg:flex-row w-full max-w-7xl items-center justify-between space-y-6 sm:space-y-0">
                ...
                <div className="relative z-10 w-full max-w-xl">
                    <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-gray-200 p-8 flex flex-col gap-y-4">
                        ...
                        {/* Features */}
                        {[
                            { Icon: Shield, title: "Secure Login", desc: "Your data is protected with encryption", color: "from-blue-500 to-purple-600" },
                            { Icon: Zap, title: "Instant Access", desc: "Jump right back into your projects", color: "from-green-500 to-blue-600" },
                            { Icon: Users, title: "Team Collaboration", desc: "Work together seamlessly", color: "from-purple-500 to-pink-600" }
                        ].map(({ Icon, title, desc, color }, i) => (
                            <div key={i} className="flex items-center gap-4 bg-white/60 backdrop-blur-sm rounded-xl p-4 border border-gray-200">
                        ...
                        <div className="mt-8 grid grid-cols-1 sm:grid-cols-3 gap-4 text-center">
                            {[
                                { value: "10K+", label: "Active Users", color: "from-blue-50 to-purple-50" },
                                { value: "99.9%", label: "Uptime", color: "from-green-50 to-blue-50" },
                                { value: "24/7", label: "Support", color: "from-purple-50 to-pink-50" }
                            ].map(({ value, label, color }, i) => (
                                <div key={i} className={`bg-gradient-to-r ${color} rounded-xl p-4`}>
